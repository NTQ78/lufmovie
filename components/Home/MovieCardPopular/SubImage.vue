<template>
  <div v-if="loader" class="image-container">
    <img
      :src="`https://image.tmdb.org/t/p/original${ListImgRenges[8]?.poster_path}`"
      alt=""
    />
    <img
    ...
    />
    <img
      :src="`https://image.tmdb.org/t/p/original${ListImgRenges[5]?.poster_path}`"
      alt=""
    />
    <img
      :src="`https://image.tmdb.org/t/p/original${ListImgRenges[7]?.poster_path}`"
      alt=""
    />
  </div>
